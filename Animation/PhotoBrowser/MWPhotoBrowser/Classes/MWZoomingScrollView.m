...
- (void)displayImageFailure {
    ...
    if (!_loadingError) {
        ...
        _loadingError.image = [UIImage imageNamed:imageDisplayFailure];
...
- (void)handleSingleTap:(CGPoint)touchPoint {
    [_photoBrowser performSelector:@selector(toggleControls:) withObject:_photoImageView afterDelay:0.2];
}
...
- (void)imageView:(UIImageView *)imageView longTapDetected:(UITouch *)touch{
    [_photoBrowser performSelector:@selector(longPress) withObject:nil afterDelay:0.2];
}
